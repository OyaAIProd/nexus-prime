...
- Packet Hash: bcb5c730be3033b026c91bcfa67d528206fa0751
- Runtime: client-bootstrap-cline
- Session: client-bootstrap-cline
- Client: Cline
- Mode: autonomous

## Task
Bootstrap Cline to use Nexus Prime through the default MCP sequence.
...
- **Session end**: `nexus_store_memory(content="Session YYYY-MM-DD: <summary>", pri
